...
<div class="content">
    <div class="animated fadeIn">
        <div class="row">
            <div class="col-lg-6">
                <div class="card">
                    <form action="/agenda-kegiatan/perencanaan/update/{{$data_agenda->id}}" method="post" enctype="multipart/form-data">
                        {{csrf_field()}}
                        <div class="card-header"><strong>Pengajuan Proposal</strong><small> Update</small></div>
                        <div class="card-body card-block">
                            ...
                            <div class="form-group">
                                ...
                                <a href="{{URL::to('/')}}/public/dokumen/{{ $data_agenda->suratP }}">{{$data_agenda->proposal}}</a>
                            </div>
                            <div class="form-group">
                        ...
                        <button class="btn btn-success" type="submit" style="float: right; margin-right: 20px;">UPDATE DATA</button>
                    </form>
                </div>
            </div>
        </div>
